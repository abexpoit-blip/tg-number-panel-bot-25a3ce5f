...
async def _ensure_columns(conn):
    ...
    stmts = [
        ...
        # Replace the old phone/service uniqueness so the same phone can exist
        # in different country ranges without false duplicate skips.
        "ALTER TABLE numbers DROP CONSTRAINT IF EXISTS uq_phone_service",
        "DROP INDEX IF EXISTS uq_phone_service",
        "DROP INDEX IF EXISTS uq_phone_service_range",
        "DROP INDEX IF EXISTS uq_phone_service_norange",
